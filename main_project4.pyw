...
my_newlabel.pack()
player = tkvideo.tkvideo(current_directory+"\\animation_4.mp4", my_newlabel, loop = 1, size = (1520,820))
...
user=Entry(root,bg="#891A31",fg="white",width=16,font=('',16 , 'bold'))
...
def Save():
    global name
    name=user.get()
Button(root , bg="#272525", fg="#5FC1DB",text ="save", command=Save,font= "big.TButton",height = 1,width = 4).place (x=540,y =220)
...
Button(root ,bg="#272525", fg="#5FC1DB", text ="save",font= "big.TButton", command=save,height = 1,width = 4).place (x=540,y =298)

gender_listbox = Listbox(root)
gender_listbox.insert(END,'MALE')
gender_listbox.insert(END,'FEMALE')
bolded = font.Font(weight='bold')
gender_listbox.config(background="#891A31",foreground="white",font=bolded)
...
Button(root , bg="#272525", fg="#5FC1DB",text ="save",font= "big.TButton", command=save,height = 1,width = 4).place (x=540,y =375)

age=Listbox(root)
for i in range(18,81):
    age.insert(END,i)
    bolded = font.Font(weight='bold')
age.config(background="#891A31",foreground="white",font=bolded)
...
def save():
    ...
    weight = itm
Button(root , bg="#272525", fg="#5FC1DB",text ="save", command=save,font= "big.TButton",height = 1,width = 4).place (x=540,y =450)

weight_listbox=Listbox(root)
for i in range(34,181):
    weight_listbox.insert(END,i)
    bolded = font.Font(weight='bold')
weight_listbox.config(background="#891A31",foreground="white",font=bolded)
...
def save():
    ...
    height = itm
Button(root ,bg="#272525", fg="#5FC1DB", text ="save", command=save,font= "big.TButton",height = 1,width = 4).place (x=540,y =528)

height_listbox=Listbox(root)
for i in range(140,211):
    height_listbox.insert(END,i)
    bolded = font.Font(weight='bold')
height_listbox.config(background="#891A31",foreground="white",font=bolded)
...
Button(root ,bg="#272525", fg="#5FC1DB", text ="save", command=save,font= "big.TButton",height = 1,width = 4).place (x=540,y =610)
...
bolded = font.Font(weight='bold')
marital_sta.config(background="#891A31",foreground="white",font=bolded)
...
Button(root ,bg="#272525", fg="#5FC1DB", text ="save", command=save,font= "big.TButton", height = 1,width = 4).place (x=1280,y =220)
...
bolded = font.Font(weight='bold')
income.config(background="#891A31",foreground="white",font=bolded)
...
def save():
    ...
    if itm == "NEVER":
        ...
        itm = 4
    workout = itm
Button(root ,bg="#272525", fg="#5FC1DB", text ="save", command=save,font= "big.TButton", height = 1,width = 4).place (x=1280,y =298)
...
bolded = font.Font(weight='bold')
exercise.config(background="#891A31",foreground="white",font=bolded)
...
def save():
    ...
    if itm == "POOR":
        ...
        itm = 4
    general_health = itm
Button(root ,bg="#272525", fg="#5FC1DB", text ="save", command=save,font= "big.TButton", height = 1,width = 4).place (x=1280,y =375)
...
bolded = font.Font(weight='bold')
health.config(background="#891A31",foreground="white",font=bolded)
...
def save():
    ...
    if itm == "NO":
        ...
        itm = 0
    diabetic = itm
Button(root ,bg="#272525", fg="#5FC1DB", text ="save", command=save,font= "big.TButton", height = 1,width = 4).place (x=1280,y =450)

diabetes_listbox= Listbox(root)
diabetes_listbox.insert(END,'NO')
diabetes_listbox.insert(END,'YES')
bolded = font.Font(weight='bold')
diabetes_listbox.config(background="#891A31",foreground="white",font=bolded)
...
def save():
    ...
    if itm == "DON'T CONSUME":
        ...
        itm = 0   
    alcohol = itm
Button(root ,bg="#272525", fg="#5FC1DB", text ="save", command=save,font= "big.TButton", height = 1,width = 4).place (x=1280,y =528)
...
bolded = font.Font(weight='bold')
alchol.config(background="#891A31",foreground="white",font=bolded)
...
Button(root , bg="#272525", fg="#5FC1DB",text ="save", command=save,font= "big.TButton", height = 1,width = 4).place (x=1280,y =610)
...
bolded = font.Font(weight='bold')
smoking_listbox.config(background="#891A31",foreground="white",font=bolded)
...
# The video is Imported and displayed
       my_newlabel_ = Label(open_window)
       my_newlabel_.pack()
       player = tkvideo.tkvideo(current_directory+"\\ending_animation4.mp4", my_newlabel_, loop = 1, size = (width,height-80))
...
# Returning the outputs in boxes
       ...
       name_text.config(background="#891A31",foreground="white",borderwidth=0,state=DISABLED)
       ...
       prediction_text.config(background="#891A31",foreground="white",borderwidth=0,state=DISABLED)
